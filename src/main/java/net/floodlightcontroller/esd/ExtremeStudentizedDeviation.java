package net.floodlightcontroller.esd;
...
public class ExtremeStudentizedDeviation {
	private static final Logger log = LoggerFactory.getLogger(ExtremeStudentizedDeviation.class);
...
//	public long[] S = new long[k];		// 1 x k; last k sample time eigenvalues vector	
	...
	public ExtremeStudentizedDeviation() {
		// TODO Auto-generated constructor stub
	}
	
	public ExtremeStudentizedDeviation(long[] C, int m, int K) {
		this.m = m;
		this.k = K;
		this.C = C;
//		Average();
